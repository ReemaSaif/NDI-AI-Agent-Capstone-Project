...
def map_percentage_to_scale(score: float) -> int:
    """Converts a percentage (0–100) into SDAIA's OE scale (0–5)"""
...
# MATURITY LEVELS (0-5)
def get_maturity_level(percentage: float) -> dict:
    """ Returns the SDAIA maturity level object based on the percentage."""
    for level in reversed(MATURITY_LEVELS):  # check highest to lowest
...
MATURITY_LEVELS = [
    {
        "level": 0,
        "label": "Absence of Capabilities",
        "description": "No established practices",
        "min_percentage": 0.0
    },
    {
        "level": 1,
        "label": "Establishing",
        "description": "Basic practices introduced but not standardized",
        "min_percentage": 5.0
    },
    {
        "level": 2,
        "label": "Defined",
        "description": "Developed and consistent practices",
        "min_percentage": 25.0
    },
    {
        "level": 3,
        "label": "Activated",
        "description": "Institutional processes and scalable tools",
        "min_percentage": 50.0
    },
    {
        "level": 4,
        "label": "Managed",
        "description": "Centralized governance with KPIs and metrics",
        "min_percentage": 80.0
    },
    {
        "level": 5,
...
def evaluate_oe(entity_name: str, cycle_name: str, data: Dict[str, Any]) -> OEResult:
    ...
    maturity = get_maturity_level(final_score)
